...
p0 = Popen(['python', 'read-anchor.py', "/dev/ttyACM0"], stdin=PIPE, stdout=PIPE, stderr=PIPE)
p1 = Popen(['python', 'read-anchor.py', "/dev/ttyACM1"], stdin=PIPE, stdout=PIPE, stderr=PIPE)
p2 = Popen(['python', 'read-anchor.py', "/dev/ttyACM2"], stdin=PIPE, stdout=PIPE, stderr=PIPE)
p3 = Popen(['python', 'read-anchor.py', "/dev/ttyACM3"], stdin=PIPE, stdout=PIPE, stderr=PIPE)
